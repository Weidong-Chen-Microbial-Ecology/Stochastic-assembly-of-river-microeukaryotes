...
#write 3 files: p.csv, freq.csv and freq.pred.csv
...
#put the 3 files into 1 file named:"neutral_file.txt", and using the following code:
argnls=read.table("neutral_file.txt",row.names=1,header=T)
